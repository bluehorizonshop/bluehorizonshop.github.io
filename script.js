function cargarProductos(categoria = 'todos') {
    ...
    container.innerHTML = `
        <div style="grid-column: 1 / -1; text-align: center; padding: 40px;">
            <i class="fas fa-spinner fa-spin" style="font-size: 3rem; color: var(--azul-principal);"></i>
    ...
    // Nombres descriptivos para cada categoría (ACTUALIZADO PARA BLUE HORIZON)
    const nombresCategorias = {
        'todos': 'Todos los productos',
        'bodys': 'Bodys',
        'mamelucos': 'Mamelucos y Conjuntos',
        'gorros': 'Gorros, Medias y Manoplas',
        'calzado': 'Calzado y Zapatitos',
        'accesorios': 'Accesorios y Biberones'
    };
    ...
    if (productosFiltrados.length === 0) {
        container.innerHTML = `
            <div style="grid-column: 1 / -1; text-align: center; padding: 40px; color: var(--azul-suave);">
    ...
    productosFiltrados.forEach(producto => {
        ...
        if (producto.tieneFoto && producto.foto) {
            ...
            // Iconos por categoría (con el icono para bebé y ropa)
            const iconosPorCategoria = {
                'bodys': 'fa-tshirt',
                'mamelucos': 'fa-child',
                'gorros': 'fa-hat-cowboy',
...
function mostrarMensajeProteccion() {
    ...
    mensaje.innerHTML = `
        <div class="mensaje-proteccion">
            ...
            <p>¡Gracias por visitar Blue Horizon!</p>
        </div>
    `;
...
function configurarWhatsApp() {
    ...
    if (btnWhatsApp) {
        btnWhatsApp.href = `https://wa.me/${NUMERO_BLUE_HORIZON}`;
    }
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('✅ Blue Horizon - Modal simplificado listo');
});